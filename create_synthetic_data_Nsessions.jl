...
if occursin("Users",auxpath)
    ...
    path_synthetic_data="C:\\Users\\Tiffany\\Google Drive\\WORKING_MEMORY\\MODEL\\HMM_wm_mice-main\\synthetic\\"
    path_real_data="C:\\Users\\Tiffany\\Google Drive\\WORKING_MEMORY\\MODEL\\HMM_wm_mice-main\\real\\"

else
    path_functions="/home/tiffany/HMM_wm_mice-main/functions/"
    path_figures="/home/tiffany/HMM_wm_mice-main/figure/"
    path_synthetic_data="/home/tiffany/HMM_wm_mice-main/synthetic/"
    path_real_data="/home/tiffany/HMM_wm_mice-main/synthetic/"
...
y=[   1.0,   1.0, 0.00,    2.5,     2.5, 0.01]
args=["pi","t11","t22","c2","sigma","x0","beta_w","beta_l","beta_bias"]
x=[ 1.0, PDwDw, PBiasBias,  4.0,   1.0, 0.0,   5.0,   2.0, 3]
data_set_num=7
#
#
# PDwDw=0.9
...
# args=["pi","t11","t22","c2","sigma","x0","beta_w","beta_l","beta_bias"]
# x=[ 1.0,PDwDw, PBiasBias,  3.5,   1.0, 0.0,   5.0,   -3.0, -3]
# data_set_num=3

# PDwDw=0.9753
# PBiasBias=0.8621
# consts=["sigma","c4","x0","tau_w","tau_l","lambda"]
# y = [1.00, 1.00, 0, 1.8, 1.8, 0]
# args=["pi","t11","t22","mu_k","c2","mu_b","beta_w","beta_l","beta_bias"]
# x=[ 1.0,PDwDw, PBiasBias,  2.35,   4.75, 0.0,  2.73,   1.069, -3.827]
# data_set_num="E22"

# PDwDw=0.9
# PBiasBias=0.9
# consts=["mu_k","c4","mu_b","tau_w","tau_l","lambda"]
# y=[   1.0,   1.0, 0.3,    2.5,     2.5, 0.01]
# args=["pi","t11","t22","c2","sigma","x0","beta_w","beta_l","beta_bias"]
# x=[ 1.0,PDwDw, PBiasBias,  4.,   1.0, 0.0,   5.0,   1.0,0.0]
# data_set_num=4
#
#
# PDwDw=0.9
...
# y=[   1.0,   1.0, 0.00,    2.5,     2.5, 0.01]
# args=["pi","t11","t22","c2","sigma","x0","beta_w","beta_l","beta_bias"]
# x=[ 1.0,PDwDw, PBiasBias,  4.,   1.0, 0.0,   3.0,   1.0,1.5]
# data_set_num=5
...
filename_save=path_synthetic_data*"data_set"*string(data_set_num)*"_50Sessions.jld"
...
filename_save=path_synthetic_data*"data_set"*string(data_set_num)*"_model_params.json"
...
:idelays=> idelays, :day, "day")

df=Pandas.DataFrame(dict)
filename_save=path_synthetic_data*"data_set"*string(data_set_num)*"_behavior_params.json"
